...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Stock & Purchase</h1><a href="purchases/create" class="btn btn-primary btn-sm btn-add" role="button">Add Stock</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li><a href="/purchases">Stock & Purchase</a></li> 
				<li class="parties"><strong>Stock & Purchase</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h3 class="panel-title">Manage Stock & Purchase</h3>
						...
						<div class="panel-body">
						  ...
						  @foreach($purchases as $purchase)
							<tr>
								...
								<td class="center">{{$purchase->reference_no}}</td>
								<td class="center">{{$purchase->suppliers->name}}</td>
