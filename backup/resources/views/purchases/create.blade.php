									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="row">
												...
												<div class="col-sm-2"><h5><b><center>Cost</center></b></h5></div>
...
function AddRowFunction() {
	...
	// html = html + '</select>';
	html = html + '{!! Form::text('product_name', null, ['id' => 'product_name', 'onkeyup' => 'javascript:productMouseUp($(this).val(), $(this).closest(\'tr\').index())', 'class'=>'form-control']) !!}';
	html = html + '</td>';
	html = html + '</div>';
