			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Quotation</h2>
						<div class="box-icon">
					...
					{!! Form::model($edit, ['method' => 'PATCH', 'action' => ['QuotationController@update', $edit->id], 'class' => 'form-horizontal' ]) !!}
						  <fieldset>
