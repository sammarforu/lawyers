...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Clients Information</h1><a href="parties/create" class="btn btn-primary btn-sm btn-add" role="button">Add New Client</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="parties"><strong>Clients</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="panel-body">
						  ...
						  @foreach($party as $parties)
							...
							<tr>
								...
								<td class="center">{{$parties->type}}</td>
