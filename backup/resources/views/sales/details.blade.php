...
@section("contents")
		<div class="row">
			<div class="col-md-12">
				<a href="/sales/print/{{$newsale_detail[0]->id}}" class="btn btn-warning" role="button" style="float:right;"><i class="fa fa-print"></i><span class="bold">Print</span></a>
				<!-- Card grid view -->
								...
								<table class="table table-striped table-bordered table-hover dataTables-example" >
									...
									@foreach ($newsale_detail[0]->sale_details as $details)
										...
										<tr class="gradeX">
											...
											<td>{{$details->discount->title }}</td>
											<td>{{$details->total_cost}}</td>
										</tr>
										<?php 
										$nettotal = $nettotal + $details->total_cost;
										//$totaldiscount = $totaldiscount + $details->quantity * $details->unit_cost - $details->discount ;
									...
									@endforeach
										<tr class="gradeX">
											<center><td colspan="5" style="padding-left: 800px;">Total</td></center>
											<td><?php echo $total; ?></td>
										</tr>
										<tr class="gradeX">
											<center><td colspan="5" style="padding-left: 755px;">Total Discount</td></center>
											<td><?php echo $totaldiscount; ?></td>
										</tr>
										<!--<tr class="gradeX">
											<center><td colspan="6" style="padding-left: 795px;">Total Tax</td></center>
											<td><?php echo $totaltax; ?></td>
										</tr>-->
										<tr class="gradeX">
											<center><td colspan="5" style="padding-left: 780px;">Grand Total</td></center>
