...
session_start();	
	...
	$system_title = $row['title'];
	$system_name = $row['system_name'];
	
	$que="select * from system_logos";
	$run=@mysql_query($que);
	$logo=@mysql_fetch_array($run);
	$system_logo = $logo['image'];
...
<!-- Site favicon -->
<link rel='shortcut icon' type='image/x-icon' href='/upload/logo/<?php echo $system_logo; ?>' />
<!-- /site favicon -->
...
<div class="page-container">
	...
	<div class="page-sidebar">
		...
		<header class="site-header">
		  <div class="site-logo"><a href="/dashboard"><img src="/upload/logo/<?php echo $system_logo; ?>" alt="<?php echo $system_name; ?>" title="<?php echo $system_name; ?>" style="width:200px;"></a></div>
		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub"><a href="#"><i class="icon-layout"></i><span class="title">Tax & Discount</span></a>
				<ul class="nav collapse">
					...
					<li><a href="/catagories"><span class="title">Catagories</span></a></li>
				</ul>
			</li>
			<li class="has-sub"><a href="#"><i class="icon-layout"></i><span class="title">Accounts</span></a>
				<ul class="nav collapse">
					<li><a href="/ledger"><span class="title">Ledgers</span></a></li>
					<li><a href="/expenses"><span class="title">Expenses</span></a></li>
			...
			<?php //if ($system_logo = null){	
				//echo '<a href="/settings/1/edit"><i class="icon-cog"></i><span class="title">General Settings</span></a>';
				//}
				//else{
					//echo '<a href="/settings/create"><i class="icon-cog"></i><span class="title">General Settings</span></a>';
				//}
			 ?>
			<li><a href="/account/{{ Auth::user()->id }}/edit"><i class="icon-cog"></i><span class="title">Account Settings</span></a>
			<li class="has-sub"><a href="basic-tables.html"><i class="icon-window"></i><span class="title">Reports</span></a>
				<ul class="nav collapse">
			...
			<ul class="user-info pull-left">          
			  <li class="profile-info dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" 
				...
				<ul class="dropdown-menu">
				  ...
				  <li class="divider"></li>
				  <li><a href="/settings/1/edit"><i class="icon-cog"></i>General settings</a></li>
  ...
  <!-- /main container -->
	...
	<center><footer class="footer-main" style="background: #16202F;"> 
				&copy; 2016 <strong><?php echo $system_title; ?>.</strong> Developed By <a target="_blank" href="http://www.stechsofts.com/">STech Softs</a> 
			</footer></center>
<!-- /page container -->
