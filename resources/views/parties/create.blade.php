...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li><a href="/parties">Char Of Account</a></li> 
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				{!! Form::open(['url' => 'parties', 'class' => 'form-horizontal' ]) !!}
					...
					<div class="form-group" style="width: -webkit-fill-available;"> 
						...
						<div class="col-sm-5"> 
							{!! Form::select('account_show_id', $AccountGroups, null, ['id' => 'account_show_id', 'onchange' => 'AccountName($(this).val().split("_").pop(), $(this).val().split("_")[0]);', 'class'=>'form-control livesearch']) !!}
						</div> 
					</div>
					...
					<div class="form-group" style="display: none;"> 
						<label class="col-sm-3 control-label">Account Type</label>  
						<div class="col-sm-5"> 
						{!! Form::text('account_type', null, ['id' => 'account_type','class'=>'form-control',]) !!}
						</div> 
					</div>
					<div class="form-group"> 
