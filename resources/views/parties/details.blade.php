...
@section("contents")
		<div class="row">
			<div class="col-md-12">
				<a href="/parties/print/{{$party[0]->id}}" class="btn btn-warning" role="button" style="float:right;"><i class="fa fa-print"></i><span class="bold">Print</span></a>
				<!-- Card grid view -->
						...
						<div class="col-lg-12 col-sm-6 ">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" >
									...
									@endforeach
										<tr class="gradeX">
											<center><td colspan="3" style="padding-left: 780px;">Total</td></center>
