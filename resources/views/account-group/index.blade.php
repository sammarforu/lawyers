...
<div class="page-heading clearfix">
	<h1 class="page-title pull-left">Account Group</h1><a href="account-group/create" class="btn btn-primary btn-sm btn-add" role="button">Add Account Group</a>
</div>
<!--
...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<!-- <li><a href="/parties">Account Group</a></li>  -->
	<li class="active"><strong>Account Groups</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage Account Groups</h3>
					...
					<td class="size-80 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="/account-group/{{$group->id}}/edit">Edit</a></li>
								<li><a href="javascript:checkDelete({{ $group->id }}, '/account-group/{{ $group->id }}/destroy', '/account-group');">Delete</a> </li>
							</ul>
						</div>
					</td>
				</tr>
