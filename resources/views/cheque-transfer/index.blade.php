@extends("app")
@section("contents")
<h1 class="page-title">Bank Payment Report</h1><a href="bank-payments/create" class="btn btn-primary btn-sm btn-add" role="button">Add Bank Payment</a>
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="/dashboard"><i class="fa fa-home"></i>Home</a></li> 
				<li class="active"><strong>Bank Payment Report</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<input id="token" type="hidden" value="{{$encrypted_token}}">
							...
							{!! Form::open(['url' => 'bank-payments/report', 'class' => 'form-horizontal' ]) !!}
