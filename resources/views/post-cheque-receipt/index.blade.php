@extends("app")
@section("contents")
<h1 class="page-title">Cheque Payment Report</h1><a href="cheque-payments/create" class="btn btn-primary btn-sm btn-add" role="button">Add Cheque Payment</a>
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="/dashboard"><i class="fa fa-home"></i>Home</a></li> 
				<li class="active"><strong>Cheque Payment Report</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<input id="token" type="hidden" value="{{$encrypted_token}}">
							...
							{!! Form::open(['url' => 'cheque-payments/report', 'class' => 'form-horizontal' ]) !!}
								<div class="form-group"> 
									<label class="col-sm-3 control-label">Party&nbsp;/&nbsp;Customer</label>  
									<div class="col-sm-5"> 
