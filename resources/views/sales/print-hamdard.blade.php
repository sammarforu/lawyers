...
<div class="card">
	...
	<div class="card-content" style=" margin-top: 5px; border:1px solid; border-radius:10px;">
		...
		<h5 style="float:right; margin-top: -0px; margin-right: -143px;">Sale Type: <u>{{$newsale_detail[0]->sale_type}}</u></h5>
		<h5 style="float:right; margin-top: 20px; margin-right: -142px;">Due Date: <u>{{date("d/m/Y", strtotime($newsale_detail[0]->due_date))}}</u></h5>
		@endif
