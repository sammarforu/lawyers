...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Income Tax Management</h1><a href="{{url('income-tax/create')}}" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
								...
								<td class="size-80 text-center">
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="{{url('/income-tax/details/')}}/{{$ntn->id}}">Details</a></li>
											<li><a href="{{url('/income-tax/')}}/{{$ntn->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $ntn->id }}, '/income-tax/{{ $ntn->id }}/destroy', '/income-tax/{{$office[0]->id}}');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
