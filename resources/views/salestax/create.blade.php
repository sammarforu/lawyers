				...
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						...
						<div class="container">
							...
							<div class="col-xs-2"><label class="radio-inline" style=""><input type="checkbox" name="autocash" id="autocash" value="yes">Auto&nbsp;Cash</label> </div>
...
$("#btnSave").click(function()
{
	...
	//purchase.autocash = $("#autocash").val();
