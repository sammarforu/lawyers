...
<div class="page-heading clearfix">
	<h1 class="page-title pull-left">Manage GRN's</h1><a href="grn/create" class="btn btn-primary btn-sm btn-add" role="button">Add GRN</a>
</div>
<!--
...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong>Manage GRN's</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage GRN's</h3>
  ...
  @foreach($purchases as $purchase)
	<tr>
		...
		<td class="size-80 text-center">
			<div class="row">
				<a href="/grn/print/{{$purchase->id}}" target="__blank" style="color:white;">
		...
		<td class="size-80 text-center">
			<div class="row">
				<a href="/grn/{{$purchase->id}}/edit" style="color:white;">
				<button class="btn btn-black" type="button"> <i class="fa fa-paste" title="Edit Invoice"></i></button></a>
				<a href="javascript:checkDelete({{ $purchase->id }}, '/grn/{{ $purchase->id }}/destroy', '/grn');" target="__blank">
		...
		<!-- <td class="size-80 text-center">
			<div class="dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="/grn/{{$purchase->id}}" target="__blank">Invoice</a></li>
					<li><a href="/grn/print/{{$purchase->id}}" target="__blank">Print Invoice</a></li>
					 <li><a href="/purchases/{{$purchase->id}}/edit">Edit</a></li> <li><a href="javascript:checkDelete({{ $purchase->id }}, '/purchases/{{ $purchase->id }}/destroy', '/purchases');">Delete</a> </li>
				</ul>
			</div>
		</td> -->
	</tr>
