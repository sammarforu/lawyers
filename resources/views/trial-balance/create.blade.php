				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<input id="token" type="hidden" value="{{$encrypted_token}}">
							...
							{!! Form::open(['url' => 'expense-head-report', 'class' => 'form-horizontal' ]) !!}
								<div class="form-group"> 
									<label class="col-sm-3 control-label">Select Supplier/Buyer</label>  
									<div class="col-sm-5"> 
									{!! Form::select('expensehead_id', $ExpenseHeads, null, ['id' => 'expensehead_id','class'=>'form-control livesearch', 'required' => 'required']) !!}
									</div> 
								</div>
								<div class="form-group"> 
