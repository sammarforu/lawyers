@extends("app")
@section("contents")
<h1 class="page-title">Stock Register (Specific Item)</h1><!-- <a href="bank-payments/create" class="btn btn-primary btn-sm btn-add" role="button">Add Bank Payment</a> -->
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="/dashboard"><i class="fa fa-home"></i>Home</a></li> 
				<li class="active"><strong>Specific Item</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h3 class="panel-title">Stock Register (Specific Item)</h3>
						...
						<input id="token" type="hidden" value="{{$encrypted_token}}">
							...
							{!! Form::open(['url' => 'stock-register-specific-item-fifo/report', 'class' => 'form-horizontal' ]) !!}
								<div class="form-group"> 
									<label class="col-sm-3 control-label">Select Item</label>  
									<div class="col-sm-5"> 
									{!! Form::select('product_id', $products, null, ['id' => 'product_id','class'=>'form-control livesearch']) !!}
									</div> 
								</div>
								<!-- <div class="form-group"> 
