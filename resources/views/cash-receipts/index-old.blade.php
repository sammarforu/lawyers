...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Sales</h1><a href="sales/create" class="btn btn-primary btn-sm btn-add" role="button">Add Sale</a>
			</div>
			<!--
						...
						<div class="panel-body">
						  ...
						  <?php $sum = $sum + 1; ?>
							<tr><td class="center">{{$sum}}</td>
								...
								<!-- <td class="center">{{$sale->localExport}}</td> -->
								...
								<td class="size-80 text-center">
									<!-- <button class="btn btn-info btn-md"><a href="/sales/print/{{$sale->id}}" target="__blank" style="color:white;">Print Invoice</a></button>
									<button class="btn btn-red" type="button"> <i class="icon-cancel"></i> </button> --> 
									<div class="row">
										...
										<a href="javascript:checkDelete({{ $sale->id }}, '/sales/{{ $sale->id }}/destroy', '/sales');" target="__blank">
