	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix" id="panelbg">
				<h2 class="panel-title"><b>Add Cash Receipt Voucher</b></h2>
		...
		<div class="panel-body">
			...
			{!! Form::open(['url' => 'cash-receipts', 'class' => 'form-horizontal' ]) !!}
			<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix" id="subpanelbg">
						<h3 class="panel-title">Cash Receipt Grid</h3>
					</div>
					<div class="panel-body">
							...
							<table class="table table-bordered">
								<thead> 
									<tr> 
										...
										<th>Date</th>  
										<thstyle="display:none;">Voucher&nbsp;No</th> 
...
{
alertify.confirm("Are you sure you want Add Cash Receipt Voucher?", function (e) {
	if (e)
	{
	...
	jQuery.ajax({
		...
		success: function(result) {
			...
			//if(parseInt(result) > 0)
			{
				...
				window.location.href = "/cash-receipts/create";
				//alert("Cash Receipt successfully saved.");
				window.open("/cash-receipts/"+result);
