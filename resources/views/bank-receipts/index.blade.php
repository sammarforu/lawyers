...
<div class="container-fluid">
	...
	<div class="page-heading clearfix">
		<h1 class="page-title pull-left">Manage Bank Receipts</h1><a href="/bank-receipts/create" class="btn btn-primary btn-sm btn-add" role="button">Add Bank Receipt</a>
	</div>
	</div>
	<div class="col-sm-3">
		<div class="page-heading clearfix">
...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong>Bank Receipt</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage Bank Receipts</h3>
...
<tr>
	...
	<?php $Totoldebit = $Totoldebit+$data->debit; ?>
	@endforeach
	<td class="center">{{$Totoldebit}}</td>
	...
	<td class="size-80 text-center">
		<div class="row">
			<a href="/bank-receipts/{{$Voucher->id}}" target="__blank" style="color:white;">
	...
	<td class="size-80 text-center">
			...
			<a href="/bank-receipts/{{$Voucher->id}}/edit" style="color:white;">
			...
			<a href="javascript:checkDelete({{ $Voucher->id }}, '/bank-receipts/{{ $Voucher->id }}/destroy', '/bank-receipts');" target="__blank">
