	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h2 class="panel-title"><b>Add Opening Balance</b></h2>
...
<div class="col-md-2" style="display:none;"> 
	<div class="form-group"> 
		...
		{!! Form::text('v_type', 'OPENING BALANCE', ['id' => 'v_type', 'class'=>'form-control']) !!}
	</div> 
</div>
<div class="col-md-2" style="margin-left: 1%; margin-right: 1%;"> 
	<div class="form-group"> 
		<label for="Name" class="control-label">Account&nbsp;Name</label> 
		{!! Form::select('account_head_id', $Heads, null, ['id' => 'account_head_id', 'class'=>'form-control livesearch']) !!}
	</div> 
</div> 
		...
		<label for="password" class="control-label">Add</label>
		 ...
		 <!-- <button type="button" onclick="AddGridData()" class="btn btn-red"><i class="fa fa-plus"></i> </button> -->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">Opening Balance Grid</h3>
					</div>
					<div class="panel-body">
	...
	jQuery.ajax({
		...
		success: function(result) {
			...
			//if(parseInt(result) > 0)
			{
				...
				window.location.href = "/general-voucher/create";
				alert("Voucher successfully saved.");
				//window.open("/sales/print/"+result);
