...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Taxes</h1><a href="taxes/create" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>Tax</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h3 class="panel-title">Manage Taxes</h3>
						...
						<div class="panel-body">
						  ...
						  @foreach($taxes as $tax)
							...
							<tr>
								<td><?php echo $sum; ?></td>
								<td class="center">{{$tax->tax_title}}</td>
								<td class="center">{{$tax->tax_rate}}</td>
								<td class="center">{{$tax->tax_type}}</td>
								<td class="size-80 text-center">
									<div class="dropdown">
										<a class="more-link" data-toggle="dropdown" href="#/"><i class="icon-dot-3 ellipsis-icon"></i></a>
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="/taxes/{{$tax->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $tax->id }}, '/taxes/{{ $tax->id }}/destroy', '/taxes');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
