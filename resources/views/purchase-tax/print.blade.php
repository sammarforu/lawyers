...
<html>
	...
	<body onload="window.print();">
			...
			<center><h3><u><strong>Purchase Tax Invoice</strong></u></h3></center>
	...
	<table>
		<tr style="background: grey;">
			...
			<th style="border:2px solid; width:50px;"><center>Rate (Rs)</center></th>
			<th style="border:2px solid; width:50px;"><center>Value Exc.Sales Tax</center></th>
			...
			<th style="border:2px solid; width:100px;"><center>Value Inc.ST & Rate</center></th>
		</tr>
		...
		<tr style="">
			...
			<td style="border-bottom:1px solid; border-right:2px solid; border-left:2px solid; width:50px;"><center>{{$details->quantity}}</center></td>
			<td style="border-bottom:1px solid; border-right:2px solid; border-left:2px solid; width:340px;"><center>{{$details->rate}}</center></td>
		...
		$ValueExcTax = $ValueExcTax + $details->quantity*$details->price;
	...
	<p style="float:right; margin-top: -33px; margin-right: 120px;"><strong>Name & Designation</strong></p></br>
