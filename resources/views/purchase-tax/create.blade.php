	...
	<div class="panel-body">
		...
		{!! Form::open(['url' => 'purchase-tax', 'class' => 'form-horizontal' ]) !!}
			...
			<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> 
				<label class="col-sm-1 control-label">Voucer&nbsp;No#</label>  
					...
					<div class="col-sm-2"> 
						<div id="year-view" class="input-group date"> 
							{!! Form::text('p_order', null, ['id' => 'p_order','class'=>'form-control', 'required' => 'required']) !!} 
						</div>
					</div>
			</div>
		</div>
		<div class="row">
				<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> <label class="col-sm-1 control-label">Remarks</label>
					...
					<label class="radio-inline"><input type="checkbox" name="lessCommercial" id="lessCommercial" value="yes">Add&nbsp;Commercial</label>
				...
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<div class="container">
						  ...
						  <div class="col-xs-2" style=""><b>Total Price</b> <input type="text" id="TotalRate" name="TotalRate" disabled	></div>
						  <div class="col-xs-2" style=""><b>Total Tax</b> <input type="text" id="TotalRate" name="TotalRate" disabled	>  </div>
						  <div class="col-xs-2" style=""> <b>Value Ex.Tax</b> <input type="text" id="TotalRate" name="TotalRate" disabled	> </div>
						  <div class="col-xs-2"> <b>Value Inc.Tax</b> <input type="text" id="TotalAmount" name="TotalAmount" disabled> </div>
						</div> 
					</div>
					<!-- <div class="panel-body">
...
// on javascript onclick on product dropdown 
	...
	function ProductKeyUp(ProductName, ProductID){
		$.ajax({
			type: "GET",
			url: "/purchasetaxproductkeyup-ajax?product_ID=" + ProductID,
			success: function(result) {
				if(result.length > 0)
				{
...
$("#btnSave").click(function()
{
	...
	jQuery.ajax({
		...
		success: function(result) {
			...
			{
				window.open("/purchase-tax/print/"+result);
				window.location.href = "/purchase-tax/create";
