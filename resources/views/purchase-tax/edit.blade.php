	...
	<div class="col-lg-12">
		...
		<div class="panel-body">
			...
			{!! Form::open(['url' => 'sales', 'class' => 'form-horizontal' ]) !!}
					...
					<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> 
						...
						<div class="col-sm-2"> 
							<select class="form-control" onchange="LedgerValues();" id="sale_type" name="sale_type">
								<option value="PurchaseTax Invoice">PurchaseTax Invoice</option>
				...
				<div class="row">
				<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> 
				<label class="col-sm-1 control-label">Voucer&nbsp;No#</label>  
					<div class="col-sm-2"> 
						<div id="year-view" class="input-group date"> 
							{!! Form::text('voucher_no', $edit->voucher_no, ['id' => 'voucher_no','class'=>'form-control', 'required' => 'required', 'autofocus' => 'autofocus']) !!} 
						</div>
					</div>
					<label class="col-sm-1 control-label">Invoice&nbsp;No#</label>  
					<div class="col-sm-2"> 
						{!! Form::text('invoice_no', $edit->invoice_no, ['id' => 'invoice_no','class'=>'form-control', 'required' => 'required']) !!} 
					</div>  
			...
			<div class="row">
				<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> <label class="col-sm-1 control-label">Remarks</label>
					<div class="col-sm-2"> 
						<div id="year-view" class="input-group date"> 
							{!! Form::text('remarks', $edit->remarks, ['id' => 'remarks','class'=>'form-control']) !!} 
						</div>
					</div>
					<label class="radio-inline"><input type="checkbox" name="lessCommercial" id="lessCommercial" value="yes">Less&nbsp;Commercial</label>
					<label class="radio-inline"><input type="radio" name="FurtherTax" id="FurtherTax" value="yess" onclick="FurtherTaxes()">Further&nbsp;Tax</label>
...
<?php $totalPrice = 0; $totalTax = 0; $totalExTax = 0; $totalIncTax = 0; ?>
		...
		<td style="padding-top:20px;">
			<input id="test" value="{{$PurchaseDetail->products->product_code}}" type="text" class="form-control"style="margin-left: 14%; width: 65%;" disabled>
		</td> 
		<td style="padding-top:20px;">
			<input id="test" value="{{$PurchaseDetail->products->product_name}}" type="text" class="form-control" style="margin-left: 7%; width: 153%;" disabled>
		</td>
		<td style="display:none;">
			<input id="test" value="{{$PurchaseDetail->uoms->id}}" type="text" class="form-control" style="margin-left: -25%;
	    	width: 120%;" disabled>
		</td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->uoms->uom}}" type="text" class="form-control" style="margin-left: 88%; width: 65%;;" disabled>
		</td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->quantity}}" type="text" class="form-control" style="margin-left: 80%;width: 65%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->rate}}" type="text" class="form-control" style="margin-left:72%; width: 65%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->stvalue}}" type="text" class="form-control" style="margin-left:64%; width: 65%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->taxvalue}}" type="text" class="form-control" style="margin-left:56%; width: 65%;" disabled>
		</td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->extratax}}" type="text" class="form-control" style="margin-left:47%; width: 65%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->extraTaxValue}}" type="text" class="form-control" style="margin-left:39%; width: 65%;" disabled>
		</td>
		<td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->price}}" type="text" class="form-control" style="margin-left:29%; width: 65%;" disabled>
		</td>
		<td style="padding-top:20px;">
	    	<input id="test" value="{{$PurchaseDetail->total}}" type="text" class="form-control" style="margin-left:21%; width: 65%;" disabled>
		</td>
		<td style="display: none;">
	    	<input id="test" value="{{$PurchaseDetail->other}}" type="text" class="form-control" style="margin-left:21%; width: 65%;" disabled>
		</td>
	    ...
	    <?php $totalPrice = $totalPrice + $PurchaseDetail->rate; ?>
...
<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<div class="container">
							<div class="col-xs-2"><label class="radio-inline"><input type="checkbox" name="autocash" id="autocash" value="yes">Auto&nbsp;Cash</label> </div>
						  <div class="col-xs-2" style=""><b>Total Price</b> <input type="text" id="TotalRate" name="TotalRate" value="{{$totalPrice}}" disabled	>  </div>
						  <div class="col-xs-2" style=""><b>Total Tax</b> <input type="text" id="TotalRate" name="TotalRate" value="{{$totalTax}}" disabled>  </div>
						  <div class="col-xs-2" style=""> <b>Value Ex.Tax</b> <input type="text" id="TotalRate" name="TotalRate" value="{{$totalExTax}}" disabled> </div>
						  <div class="col-xs-2" style="background-color:lavenderblush;"> <b>Value Inc.Tax</b> <input type="text" id="TotalAmount" name="TotalAmount" value="{{$totalIncTax}}" disabled> </div>
						</div> 
					</div>
					<!-- <div class="panel-body">
