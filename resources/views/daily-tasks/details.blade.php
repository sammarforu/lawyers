	...
	<div class="main-content" style="padding: 0px 20px;">
		...
		<div class="col-lg-12">
			<div class="page-heading clearfix">
				<h1 class="page-title" id="detailheader">Task Detail</h1>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						...
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->voucher_no}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>TASK DATE</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{date("d/m/Y", Strtotime($data[0]->task_date))}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						...
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->office->catagory_name}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						...
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->client_name}}</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						...
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->business_name}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>MATTER</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->metter}}</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>DETAILS</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->task}}</p>
						</div>
					</div>
				</div>
			</div>
