...
@section("contents")
			<div class="container-fluid">
 			...
 			<div class="row">
				...
				<div class="page-heading clearfix">
					<h1 class="page-title pull-left">Manage Cash Payments</h1><a href="cash-payments/create" class="btn btn-primary btn-sm btn-add" role="button">Add Cash Payment</a>
				</div>
				</div>
				<div class="col-sm-3">
					<div class="page-heading clearfix">
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>Cash Payments</strong></li> 
			</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage Cash Payments</h3>
...
<tr>
	...
	<td class="size-80 text-center">
		<div class="row">
			<a href="/cash-payments/{{$Voucher->id}}" target="__blank" style="color:white;">
	...
	<td class="size-80 text-center">
			...
			<a href="/cash-payments/{{$Voucher->id}}/edit" style="color:white;">
			...
			<a href="javascript:checkDelete({{ $Voucher->id }}, '/cash-payments/{{ $Voucher->id }}/destroy', '/cash-payments');" target="__blank">
