...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="panel-body">
			...
			{!! Form::model($edit, ['method' => 'PATCH', 'action' => ['CashPaymentController@update', $edit->id], 'class' => 'form-horizontal' ]) !!}
				<div class="row">
 ...
 <div class="col-md-1"> 
	...
	<table id="myData">
		...
		<tr>
			...
			<td style="display:none;">
				<input id="v_type" value="Cash Payment" type="text" class="form-control" disabled>
			</td>
			<td style="margin-left: 1%; margin-right: 1%; padding-top:2%">
			...
			<td style="margin-left: 1%; margin-right: 1%; padding-top:2%">
				<input id="product_id" value="{{$details->debit}}" style="margin-left: 105%; width: 103%;" type="text" class="form-control" disabled>
			</td>
...
alertify.confirm("Are you sure you want update Cash Payment Voucher?", function (e) {
  ...
  voucher.biller = $("#biller").val();
	...
	jQuery.ajax({
		...
		//url: "/cash-receipts",
		url: "/cash-payments/<?php echo $edit->id ?>",
		...
		success: function(result) {
			...
			//if(parseInt(result) > 0)
			{
				...
				window.location.href = "/cash-payments";
