						...
						<div class="panel-body">
						  ...
						  <?php $sum = 1; ?>
							...
							<tr>
								...
								<?php $TotalSales = $sales+$salesTax; ?>
								<td class="center"><h4><b>{{$TotalSales}}</b></h4></td>
							</tr>
							<tr>
								<td><h3><b>Gross Profit</h3></b></td>
								<?php $GrossProfit = $TotalSales - $purchases;?>
								<td class="center"><h3><b>{{$GrossProfit}}</h3></b></td>
							</tr>
							<tr>
								<td><h3><b>Total Sale</h3></b></td>
								<td class="center"><h3><b>{{$TotalSales}}</h3></b></td>
								<td><h3><b></b></h3></td>
								<td class="center"><h3><b>{{$TotalSales}}</h3></b></td>
							</tr>
							<tr>
								<td><h3><b>Expenses</h3></b></td>
								<td class="center"><h3><b>Amount</h3></b></td>
							</tr>
							@foreach($expense as $exp)
							<tr>
								<td><h3><b>{{$exp->name}}</h3></b></td>
								<td class="center"><h3><b>{{$exp->sum}}</h3></b></td>
							</tr>
							@endforeach
							<tr>
