						...
						<div class="panel-body">
						  ...
						  @foreach($sales as $sale)
							<tr>
								...
								<td class="center">{{$sale->sale_type}}</td>
								<?php $total = 0; $discount = 0; $tax = 0; $grandtotal = 0; ?>
								@foreach($sale->sale_details as $details)
									<?php $total = $total + $details->unit_cost * $details->quantity;
									      $discount = $discount + (($details->discount->discount/100)*$details->quantity*$details->unit_cost);
										  //$discount = $discount + (($details->discount/100)*$details->quantity*$details->unit_cost);
										  //$tax = $tax + $details->taxes->tax_rate;
