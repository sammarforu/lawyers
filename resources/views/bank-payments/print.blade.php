﻿<html>
	...
	<!-- <body> -->
			...
			<center><h3><u><strong id="voucherName">Bank Payment Voucher</strong></u></h3></center></br>
	<!-- <div class="row">
		<div class="col-sm-3">
...
<!-- 		<center><h3><b>{{$newsale_detail[0]->voucher_date}}</b></h3> -->
	...
	<table>
		...
		<tr id="datafont">
			...
			<td style="border-right:1px solid; border-left:1px solid; width:20px;"><center>{{$details->debit}}</center></td>
		</tr>
		@endif
		<?php 
		...
		<tr id="datafont" style="background: grey;">
			<td style="border:1px solid; width:50px;" colspan="4"><center>
			  Total</center></td>
