...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="panel-body">
			...
			{!! Form::model($edit, ['method' => 'PATCH', 'action' => ['BankPaymentController@update', $edit->id], 'class' => 'form-horizontal' ]) !!}
				<div class="row">
...
<div class="col-md-1"> 
	...
	<table id="myData">
		...
		<tr>
			...
			<!-- 3 -->
			<td style="display:none;">
				<input id="v_type" value="Bank Payment" type="text" class="form-control" disabled>
			</td>
			<!-- 4 -->
			...
			<!-- 8 -->
			<td style="margin-left: 1%; margin-right: 1%; padding-top:2%">
				<input id="narration" value="{{$details->narration}}" style="margin-left: 2%; width: 104%;" type="text" class="form-control" disabled>
			</td>
			<!-- 9 -->
			<td style="margin-left: 1%; margin-right: 1%; padding-top:2%">
				<input id="credit" value="{{$details->debit}}" style="margin-left: 17%; width: 52%;" type="text" class="form-control" disabled>
			</td>
			<!-- 10 -->
...
<script type="text/javascript">
	...
	function AddGridData(){
		...
		//10
		tableHtml += '<td style="padding-top:2%"><button class="btn btn-red" type="button" style="margin-left: -106%;"> <i onclick="javascript:myDeleteFunction($(this).closest(\'tr\'));" class="icon-trash" title="Delete Row"></i></button></td>';
		tableHtml += '</tr>';
