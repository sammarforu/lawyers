				...
				<div class="cards-container box-view grid-view">
					<div class="row">						
						<div class="col-lg-12 col-sm-6 ">
							...
							<div class="card">
								...
								<div class="card-content" style="float: right; margin-top: -120px;">
									<h3><strong>Account Head</strong></h3>
									<h5><strong>Account Details : </strong>{{$ledgers[0]->title}}</br></h5>
									<h5><strong>Tel : </strong>{{$ledgers[0]->account_no}}</br></h5>
					...
					<table class="table table-bordered">
						...
						<tbody>
						  ...
						  @foreach($ledgers[0]->ledger_details as $ledger)
							<tr class="gradeX">
							...
							@else
							<tr>
								<td colspan="5" class="text-center" style="color:#FF0000;">No Records found.</td>
							</tr>						
							@endif
						  </tbody>
					  <!-- <thead>
