...
<body onload="window.print();">					
	<div class="row">
		<div class="col-sm-12">
			<div class="col-sm-5">
				<div class="card-header">
					<div class="card-short-description">
						<center><span class="user-name"><img src="/upload/logo/{{$logo[0]->image}}" style="float: left; margin-left: 20px;"></span></center>
					</div>
				</div>
			</div>
			<div class="col-sm-2">
			...
			<center><h4 style="margin-top: -40px; margin-right: -130px;"><strong>Delivery Challan</strong></h4></center>
			<div class="col-sm-5">
				</br></br>
				<div class="col-sm-3" style="float:right; margin-right:20%; margin-top: -50;">
					...
					<h6><strong>City : </strong>{{$purchase_detail->parties->phone}}</br></h6>
					<h6><strong>Tel&nbsp;:&nbsp;</strong>{{$purchase_detail->parties->ntn}}</h6>
				</div>
				<div class="col-sm-2" style="float:right; margin-right:-40%; margin-top: -50px;">
					...
					<h6><strong>Challan&nbsp;Type&nbsp;:&nbsp;</strong>{{$purchase_detail->type}}</br></h6>
					<h6><strong>DC&nbspNo&nbsp:&nbsp</strong>{{$purchase_detail->dcn_no}}</br></h6>
					<h6><strong>Outward&nbspGPN&nbsp:&nbsp</strong>{{$purchase_detail->outward_gpn}}</br></h6>
