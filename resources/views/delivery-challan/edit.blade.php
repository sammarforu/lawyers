...
<h1 class="page-title">Edit Delivery Challan</h1>
<ol class="breadcrumb breadcrumb-2"> 
	<li><a href="/dashboard"><i class="fa fa-home"></i>Home</a></li> 
	<li><a href="/delivery-challan">Delivery Challan</a></li> 
	<li class="active"><strong>Edit Delivery Challan</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				{!! Form::model($edit, ['method' => 'PATCH', 'action' => ['DeliveryChallanController@update', $edit->id], 'class' => 'form-horizontal' ]) !!}	
					<div class="row">
					...
					<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> 
						...
						<div class="col-sm-3"> 
						{!! Form::select('party_id', $parties, $edit->party_id, ['id' => 'party_id', 'class'=>'form-control livesearch']) !!}
						</div> 
					</div>
				</div>
...
<div class="col-md-2" style="margin-right: 1%;"> 
	...
	<table id="myData">
		...
		<td style="display:none;">
			<input id="test" value="{{$ChallanDetail->product_id}}" type="text" class="form-control" disabled>
		</td>
		<td style="padding-top:20px;">
			<input id="test" value="{{$ChallanDetail->products->product_code}}" type="text" class="form-control" style="margin-left: 7%; width: 60%;" disabled>
		</td> 
		<td style="padding-top:20px;">
			<input id="test" value="{{$ChallanDetail->products->product_name}}" type="text" class="form-control" style="margin-left: -26%; width: 178%;" disabled>
		</td>
		<td style="display:none;">
			<input id="test" value="{{$ChallanDetail->unit->id}}" type="text" class="form-control" disabled>
		</td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$ChallanDetail->unit->uom}}" type="text" class="form-control" style="margin-left: 60%; width: 60%;" disabled>
		</td>

	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$ChallanDetail->quantity}}" type="text" class="form-control" style="margin-left: 27%; width: 60%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$ChallanDetail->rate}}" type="text" class="form-control" style="margin-left: -7%; width: 120%;" disabled>
	    </td>
	    <td style="padding-top:20px;">
	    	<input id="test" value="{{$ChallanDetail->amount}}" type="text" class="form-control" style="margin-left: 20%; width: 120%;" disabled>
		</td>
	    <td style="padding-top:20px;"><button class="btn btn-red" type="button" style="margin-left: 200%;"> <i onclick="javascript:myDeleteFunction($(this).closest(\'tr\'));" class="icon-trash" title="Delete Row"></i></button></td>
	    <?php $totalRate = $totalRate + $ChallanDetail->rate; ?>
...
<script type="text/javascript">
	var sum=0;
		...
		//2
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${ProductName}" type="text" class="form-control" style="margin-left: -26%; width: 178%;" disabled></td>`;
		//3
		tableHtml += `<td style="display:none;"><input id="test" value="${UOMID}" type="text" class="form-control"  disabled></td>`;
		//4
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${UOM}" type="text" class="form-control" style="margin-left: 60%; width: 60%;" disabled></td>`;

		//tableHtml += '<td>'+ Quantity +'</td>';
		//5
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${Quantity}" type="text" class="form-control" style="margin-left: 27%; width: 60%;" disabled></td>`;
		//tableHtml += '<td>'+ CostRate +'</td>';
		//6
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${CostRate}" type="text" class="form-control" style="margin-left: -7%; width: 120%;" disabled></td>`;
		//tableHtml += '<td>'+ Amount +'</td>';
		//7
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${Amount}" type="text" class="form-control" style="margin-left: 20%; width: 120%;" disabled></td>`;
		//8
		tableHtml += '<td><button class="btn btn-red" type="button" style="    margin-left: 200%;"> <i onclick="javascript:myDeleteFunction($(this).closest(\'tr\'));" class="icon-trash" title="Delete Row"></i></button></td>';
		tableHtml += '</tr>';
