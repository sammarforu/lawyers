				...
				<table class="table table-bordered">
					...
					@foreach($edit->sale_return_details as $saleDetail) 
						<div class="row">
							...
							<td>{{$saleDetail->products->product_code}}</td> 
							<td>{{$saleDetail->products->product_name}}</td> 
							<td>{{$saleDetail->product_cost}}</td> 
							<td>{{$saleDetail->quantity}}</td> 
							<td>{{$saleDetail->cost_amount}}</td> 
							<!-- <td>{{$saleDetail->sale_rate}} -->

							</td> 
							<td><input id="test" value="{{$saleDetail->sale_rate}}" type="text" disabled></td>
							<td>{{$saleDetail->sale_amount}}</td>
							</tr> 
						</div> 
						@endforeach
					</tbody> 
