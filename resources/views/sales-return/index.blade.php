...
<div class="page-heading clearfix">
	<h1 class="page-title pull-left">Sales Returns</h1><a href="sales-return/create" class="btn btn-primary btn-sm btn-add" role="button">Add Sale Return</a>
</div>
<!--
...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong>Sales Returns</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage Sale Returns</h3>
