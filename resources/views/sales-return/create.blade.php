	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h2 class="panel-title"><b>Add Sale Return</b></h2>
			...
			<!-- <div class="row">
				...
				<div class="row">
					<div class="form-group" style="margin-left: 1%; margin-right: 1%;"> 
						<label class="col-sm-1 control-label">Sale Type</label>
						<div class="col-sm-2"> 
								{!! Form::select('sale_list', array('Sale Return' => 'Sale Return', 'Sample' => 'Sample'), null, ['id' => 'sale_list', 'onchange' => 'SampleDescription($(this).val());', 'class'=>'form-control livesearch']) !!}
						</div> 
...
// on javascript onclick on product dropdown
	...
	function AddGridData(){
		...
		tableHtml += `<td style="padding-top:20px;"><input id="test" value="${ProductCode}" type="text" class="form-control" style="margin-left: 7%;
    width: 80%;" disabled></td>`;
    	//2
...
{
	alertify.confirm("Are you sure you want Add Sale Return?", function (e) {
	if (e)
	{
