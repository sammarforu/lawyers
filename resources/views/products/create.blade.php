		...
		<div class="panel-body">
			...
			{!! Form::open(['url' => 'products', 'class' => 'form-horizontal' ]) !!}
				<div class="form-group"> 
					...
					<div class="col-sm-5"> 
					{!! Form::text('product_code', $codes, ['id' => 'product_code','class'=>'form-control',]) !!}
					</div> 
				</div>
				<div class="form-group"> 
				...
				<!-- <div class="form-group"> 
					...
					<div class="col-sm-5"> 
					{!! Form::text('pack_type', null, ['id' => 'pack_type','class'=>'form-control',]) !!}
					</div> 
				</div> -->
				<div class="form-group"> 
					<label class="col-sm-3 control-label">Pack Type</label>  
					<div class="col-sm-5"> 
					{!! Form::select('pack_type', array('BAG' => 'BAG', 'DRUM' => 'DRUM', 'CANS' => 'CANS', 'BOTTLES' => 'BOTTLES', 'COTTON' => 'COTTON'), null, ['id' => 'pack_type','class'=>'form-control livesearch',]) !!}
					</div> 
				</div>
				<div class="form-group"> 
				...
				<div class="form-group"> 
					...
					<div class="col-sm-5"> 
					{!! Form::text('product_cost', 0.00, ['id' => 'product_cost','class'=>'form-control',]) !!}
					</div> 
				</div>
				<div class="form-group"> 
					<label class="col-sm-3 control-label">Sale Price</label>
					<div class="col-sm-5"> 
					{!! Form::text('product_price', 0.00, ['id' => 'product_price','class'=>'form-control',]) !!}
					</div> 
				</div>
				<div class="form-group"> 
