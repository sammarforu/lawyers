...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Sales Tax</h1><a href="{{url('sales-tax/create')}}" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>Salex Tax Management</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="panel-body">
						  ...
						  @foreach($ntns as $ntn)
							...
							<tr>
								...
								<td class="center">{{$ntn->business_name}}</td>
								<td class="center">{{$ntn->cell_no}}</td>
								...
								<td class="size-80 text-center">
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="{{url('/sales-tax/details/')}}/{{$ntn->id}}">Details</a></li>
											<li><a href="{{url('/sales-tax/')}}/{{$ntn->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $ntn->id }}, '/sales-tax/{{ $ntn->id }}/destroy', '/sales-tax/{{$office[0]->id}}');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
