...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">All Publishers</h1><a href="publisher/create" class="btn btn-primary btn-sm btn-add" role="button">Add New Publisher</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>Publishers</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
								...
								<td class="size-80 text-center">
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="/publisher/{{$publisher->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $publisher->id }}, '/publisher/{{ $publisher->id }}/destroy', '/publisher');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
