	...
	<div class="main-content" style="padding: 0px 20px;">
		...
		<div class="col-lg-12">
			<div class="page-heading clearfix">
				<h1 class="page-title" id="detailheader">PRA Detail</h1>
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>REFERENCE NO</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->reference_no}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>PRA ID</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->pra_id}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>PRA PASSWORD</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->pra_password}}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="card primary-view">
						<div class="card-header">
							<div class="">
								<center><h5><span class="user-name"><b>PRA PIN</b></span></h5></center>
								<!-- <p class="uppercase">Agent</p> -->
							</div>
						</div>
						<div class="card-content">
							<p id="detailcontent">{{$data[0]->pra_pin}}</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<div class="card primary-view">
						...
						<div class="card-content">
							@if($data[0]->attachment!=null)
							<p id="detailcontent"><a href="{{url('upload/pra/')}}/{{$data[0]->attachment}}"><button class="btn"><i class="fa fa-download"></i>DOWNLOAD</button></a></p>
							@else
							<p id="detailcontent">NO ATTACHMENT FOUND!</p>
							@endif
						</div>
