...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">PRA</h1><a href="{{url('pra/create')}}" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>PRA Management</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
								...
								<td class="size-80 text-center">
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="{{url('/pra/details/')}}/{{$ntn->id}}">Details</a></li>
											<li><a href="{{url('/pra/')}}/{{$ntn->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $ntn->id }}, '/pra/{{ $ntn->id }}/destroy', '/pra/{{$office[0]->id}}');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
