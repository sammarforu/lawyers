...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">NTN Details</h1><a href="{{url('ntn/create')}}" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
		  ...
		  --->
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li class="active"><strong>NTN Management</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
								...
								<td class="size-80 text-center">
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li><a href="{{url('/ntn/details/')}}/{{$ntn->id}}">Details</a></li>
											<li><a href="{{url('/ntn/')}}/{{$ntn->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $ntn->id }}, '/ntn/{{ $ntn->id }}/destroy', '/ntn/{{$office[0]->id}}');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
