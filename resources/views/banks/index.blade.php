...
<div class="row">
	...
	<div class="page-heading clearfix">
		<h1 class="page-title pull-left">Banks Information</h1><a href="banks/create" class="btn btn-primary btn-sm btn-add" role="button">Add New Bank</a>
	</div>
	</div>
	<div class="col-sm-3">
		<div class="page-heading clearfix">
...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong>Banks</strong></li> 
</ol>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title">Manage Banks</h3>
					...
					<td class="size-80 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="/banks/{{$bank->id}}/edit">Edit</a></li>
								<li><a href="javascript:checkDelete({{ $bank->id }}, '/banks/{{ $bank->id }}/destroy', '/banks');">Delete</a> </li>
							</ul>
						</div>
					</td>
				</tr>
