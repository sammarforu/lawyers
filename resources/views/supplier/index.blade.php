...
@section("contents")
			...
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Suppliers</h1><a href="supplier/create" class="btn btn-primary btn-sm btn-add" role="button">Add New</a>
			</div>
			<!--
						...
						<div class="panel-body">
						  ...
						  @foreach($suppliers as $supplier)
							...
							<tr>
								...
								<td class="center">{{$supplier->city}}</td>
								
							<td class="size-80 text-center">
									<div class="dropdown">
										<a class="more-link" data-toggle="dropdown" href="#/"><i class="icon-dot-3 ellipsis-icon"></i></a>
										<ul class="dropdown-menu dropdown-menu-right">
											<!--<li><a href="/supplier/{{$supplier->id}}">Details</a></li>--->
											<li><a href="/supplier/{{$supplier->id}}/edit">Edit</a></li>
											<li><a href="javascript:checkDelete({{ $supplier->id }}, '/supplier/{{ $supplier->id }}/destroy', '/supplier');">Delete</a> </li>
										</ul>
									</div>
								</td>
							</tr>
