...
<div class="page-heading clearfix">
	<h1 class="page-title pull-left">Manage Purchases</h1><a href="purchases/create" class="btn btn-primary btn-sm btn-add" role="button">Add Purchase Bill</a>
</div>
<!--
  ...
  <?php $sum = $sum + 1; ?>
	<tr>
		...
		<td class="size-80 text-center">
			<div class="row">
				<a href="/purchases/print/{{$purchase->id}}" target="__blank" style="color:white;">
		...
		<td class="size-80 text-center">
			<div class="row">
				<a href="/purchases/{{$purchase->id}}/edit" style="color:white;">
				<button class="btn btn-black" type="button"> <i class="fa fa-paste" title="Edit Invoice"></i></button></a>
				<a href="javascript:checkDelete({{ $purchase->id }}, '/purchases/{{ $purchase->id }}/destroy', '/purchases');" target="__blank">
