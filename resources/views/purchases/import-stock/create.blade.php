...
<h1 class="page-title">Import Stock</h1>
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li><a href="{{asset('/purchases')}}">Purchases</a></li> 
				<li class="active"><strong>Import Stock</strong></li> 
			</ol>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							{!! Form::open(['url' => 'purchases/import-stock', 'class' => 'form-horizontal', 'files' => 'true', 'enctype' => 'multipart/form-data' ]) !!}
